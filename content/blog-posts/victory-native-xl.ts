...
export const victoryNativeXlChartingAndMaintenancePost: BlogPost = {
    ...
    blocks: [
        ...
        {
            type: "paragraph",
            text: "That means thinking beyond visuals too. The finishing work is usually in interaction behavior, data-shape tolerance, and clear defaults, docs and examples.",
        },
        {
            type: "heading",
            level: 2,
        ...
        {
            type: "paragraph",
            text: "1. Reproducible issues are the easiest to solve. The best issues defined expected behavior first, provided examples to reproduce the issue, and then discussed implementation.",
        },
        {
            type: "paragraph",
