...
export const projects: Project[] = [
    {
        ...
        paragraphs: [
            "Paperplane handles the repetitive iOS release path: bumping build numbers, running build/export steps with Xcode, and uploading to TestFlight.",
            "I built it to make release workflows deterministic, scriptable, and didn't want to use Xcode, EAS, or Fastlane etc. I just wanted something very simple and local.",
        ],
    ...
    },
    {
        ...
        paragraphs: [
            "Codesh reads Codex session logs from disk and surfaces session/weekly usage percentages in the menu bar, so usage is visible without opening the CLI.",
            "I built it as the new Codex app currently doesn't support this like the [CodexMonitor app](https://github.com/Dimillian/CodexMonitor) did. I wanted a tiny native utility focused on fast startup, local data only, and useful ambient feedback.",
        ],
